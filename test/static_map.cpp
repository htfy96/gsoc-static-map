...
{
    constexpr StaticMap<int, const char *, 7> cmap(make_pair(2, "apple"), make_pair(10, "banana"), make_pair(5, "pear"),
                                                   make_pair(6, "orange"), make_pair(1, "watermelon"),
                                                   make_pair(0, "peaches"), make_pair(12, "strawberry"));
...
__attribute__((noinline)) int test_2()
{
    ...
    constexpr StaticMap<constexpr_string_view, int, 6> cmap_2(make_pair("apple", 2), make_pair("banana", 10),
                                                              make_pair("pear", 5), make_pair("orange", 6),
